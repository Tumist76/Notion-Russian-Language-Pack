var strings = {
    ...
    "Archive all": "Отправить всё в архив",
    // "Unfollow this page": "Не отслеживать изменения страницы",
    // "Re-follow this page": "Снова отслеживать изменения страницы",
    ...
    "Show in timeline": "Показать в таймлайне",
    "Date range": "Диапазон дат",
    "Use separate start and end dates": "Раздельные даты начала и конца",
    "By": "По",
    //#endregion
...
var buttons = {
    ...
    "List - Full page": "Список - Полная страница",
    "Create a list as its own page.": "Создать список на отдельной странице.",
    ...
    "Show an outline of your page.": "Разместить содержание страницы",

    "Block equation": "Блок уравнения",
